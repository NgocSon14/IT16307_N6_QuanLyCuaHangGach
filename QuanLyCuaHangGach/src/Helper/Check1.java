...
public class Check1 {
    ...
    public static boolean checkMaNV(JTextField txt) {
        ...
        if (id.matches(rgx)) {
            ...
            MsgBox.alert(txt.getRootPane(), txt.getName() + " SAIIIII");
            return false;
        }
    }
    ...
    public static boolean checkMaCD(JTextField txt) {
        ...
        if (id.matches(rgx)) {
            ...
            txt.setBackground(pink);
            MsgBox.alert(txt.getRootPane(), txt.getName() + " SAIIIIII");
            return false;
        }
    }
...
//        }
    ...
    public static boolean checkMoTaCD(JTextArea txt) {
        ...
        if (id.matches(rgx)) {
            ...
            txt.setBackground(pink);
            MsgBox.alert(txt.getRootPane(), txt.getName() + " KHÔNG ĐƯỢC ĐỂ TRỐNG");
            return false;
        }
    }
    ...
    public static boolean checkNullDate(JDateChooser txt){
        ...
        if (txt.getDate() != null){
            ...
            txt.setBackground(pink);
            MsgBox.alert(txt.getRootPane(),"Chua nhap ngay");
            return true;
        } 
    }
}
